            ...
            <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-2xl p-8 text-center">
              <div className="w-full h-64 bg-green-300 rounded-xl flex items-center justify-center mb-8 relative overflow-hidden">
                ...
                >
                  ...
                  <path
                    d="M150 200 Q200 180 250 200 Q300 220 350 200 L400 180 Q450 160 500 180 Q550 200 600 180 L650 160 Q700 140 750 160 Q800 180 850 160 L900 140"
                    stroke="currentColor"
                    strokeWidth="3"
                    fill="none"
                  ...
                  />
                  <path
                    d="M100 250 Q150 230 200 250 Q250 270 300 250 L350 230 Q400 210 450 230 Q500 250 550 230 L600 210 Q650 190 700 210 Q750 230 800 210 L850 190"
                    stroke="currentColor"
                    strokeWidth="3"
                    fill="none"
                    className="text-green-600"
                  />
                  <path
                    d="M200 300 Q250 280 300 300 Q350 320 400 300 L450 280 Q500 260 550 280 Q600 300 650 280 L700 260 Q750 240 800 260"
                    stroke="currentColor"
                    strokeWidth="3"
                    fill="none"
                    className="text-green-600"
