...
const Footer = () => {
  ...
  const products = [
    ...
    { name: 'Tamarind Pulses', href: '/products/tamarind-pulses' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              <strong>Shree Jangama Jyothi Global LLP is a leading Import and Exporter</strong> and supplier of 
              high-quality agricultural commodities from India. We specialize in delivering India's 
              finest natural products to global markets.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <Link href={link.href} className="text-gray-300 hover:text-green-400 transition-colors duration-300">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {products.map((product, index) => (
                <li key={index}>
                  <Link href={product.href} className="text-gray-300 hover:text-green-400 transition-colors duration-300">
                    {product.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-300">123 Export Street</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-gray-300">info@agroexport.com</p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              Copyright © {currentYear} Agro Export Platform. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/privacy" className="text-gray-400 hover:text-green-400 text-sm transition-colors duration-300">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-gray-400 hover:text-green-400 text-sm transition-colors duration-300">
                Terms of Service
              </Link>
              <Link href="/sitemap" className="text-gray-400 hover:text-green-400 text-sm transition-colors duration-300">
                Sitemap
              </Link>
            </div>
          </div>
