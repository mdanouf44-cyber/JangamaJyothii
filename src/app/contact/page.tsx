...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with Shree Jangama Jyothi Global LLP for premium agricultural exports. Contact us for inquiries, quotes, and partnerships.',
}
...
const ContactPage = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Email Address',
      details: ['info@shreejangamajyothi.com', 'exports@shreejangamajyothi.com'],
      action: 'Send Email'
    },
    {
            ...
            <div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <button
                  type="submit"
                  className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center gap-2"
                >
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">info@shreejangamajyothi.com</span>
                  </div>
      ...
      <section className="py-16 bg-green-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg opacity-90 mb-6 max-w-2xl mx-auto">
            Connect with us instantly on WhatsApp for quick responses to your queries and urgent requirements.
          </p>
          <a
