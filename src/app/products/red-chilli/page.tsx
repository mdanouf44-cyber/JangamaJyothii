...
import { ArrowLeft, Thermometer, Palette, Award, Globe } from 'lucide-react'
  ...
  const varieties = [
    {
      ...
      description: 'Kashmiri chilli is widely appreciated for its bright natural red color and mild pungency. It is cultivated in regions where climatic conditions support slow drying and color retention, resulting in an attractive appearance and pleasant aroma.',
      features: ['Bright Red Color', 'Mild Pungency', 'Pleasant Aroma', 'Visual Appeal'],
      hsCode: '090421',
      moq: '1 Metric Ton',
      moisture: 'Max 10–12%',
    ...
    {
      name: 'Byadgi Chilli',
      description: 'Byadgi chilli is known for its deep red color, strong aroma, and moderate heat level. It is primarily grown in Karnataka and is highly valued in the spice and food processing industries.',
      features: ['Deep Red Color', 'Strong Aroma', 'Moderate Heat', 'Rich Oil Content'],
      hsCode: '090421',
      moq: '1 Metric Ton',
      moisture: 'Max 10–12%',
      shelfLife: '12–18 months',
    ...
    {
      name: 'Guntur Chilli',
      description: 'Guntur chilli is one of the most popular chilli varieties known for its high pungency, bold flavor, and strong heat level. Cultivated in Andhra Pradesh, this chilli is preferred in applications where spiciness is a key requirement.',
      features: ['High Pungency', 'Bold Flavor', 'Strong Heat', 'Premium Quality'],
      hsCode: '090421',
      moq: '1 Metric Ton',
      moisture: 'Max 10–12%',
      shelfLife: '12–18 months',
    ...
    {
      name: 'Chilli Powder',
      description: 'Our chilli powder is manufactured by grinding selected dried red chillies under hygienic and controlled conditions. The powder is finely processed to ensure uniform texture, rich color, and consistent pungency.',
      features: ['Uniform Texture', 'Rich Color', 'No Additives', 'Pure Quality'],
      hsCode: '090422',
      moq: '500 KG',
      moisture: 'Max 8–10%',
      shelfLife: '12 months',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
              <p className="mb-6">
                Our red chillies are sourced from well-known chilli-growing regions where favorable soil conditions, climate, and traditional farming practices contribute to superior quality produce. Each variety is carefully cultivated, harvested at the right stage of maturity, and naturally dried to preserve its color, flavor, and pungency.
              </p>
              <p className="mb-6">
                We work closely with farmers and processors to ensure consistency, traceability, and compliance with international export standards. We offer a wide range of red chilli varieties, including Kashmiri Chilli, Byadgi Chilli, Guntur Chilli, and finely processed Chilli Powder.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-red-100 to-orange-100 rounded-xl h-80 flex items-center justify-center border-2 border-dashed border-red-300">
                <div className="text-center">
                  ...
                  <p className="text-red-600 font-medium">{varieties[activeVariety].name}</p>
                  <p className="text-red-500 text-sm">Image will be added here</p>
                </div>
              </div>
              ...
              <div>
                ...
                {/* Features */}
                <div className="mb-6">
                  <h4 className="font-semibold text-red-700 mb-3">Key Features:</h4>
                ...
                <div className="bg-red-50 rounded-lg p-4">
                  <h4 className="font-semibold text-red-700 mb-3">Specifications:</h4>
            ...
            {[
              {
                ...
                description: 'Naturally dried and carefully processed for superior quality'
              },
              {
                icon: <Palette className="w-8 h-8" />,
                title: 'Rich Color & Aroma',
                description: 'Strong aroma and consistent quality with vibrant natural colors'
              },
              {
                icon: <Thermometer className="w-8 h-8" />,
                title: 'Multiple Varieties',
                description: 'Different heat levels and color requirements to suit all needs'
              },
              {
                icon: <Globe className="w-8 h-8" />,
                title: 'Export Grade',
                description: 'Hygienically packed and suitable for international markets'
              }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 mb-8">
              Our red chilli products are perfect for culinary preparations, spice blends, food processing industries, sauces, seasonings, and packaged food products.
            </p>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="bg-gradient-to-r from-red-700 to-orange-700 text-white rounded-2xl p-8 shadow-xl max-w-4xl mx-auto">
            ...
            <p className="text-lg mb-6 opacity-90">
              Contact us today to discuss your red chilli requirements and discover how we can support your business with premium quality red chilli products.
            </p>
