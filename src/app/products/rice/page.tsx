...
const RicePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-green-50">
      ...
      {/* Varieties Section */}
      <section className="py-12 bg-gradient-to-r from-amber-600 to-yellow-600">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-2xl max-w-[1100px] mx-auto">
            <div className="grid md:grid-cols-5 gap-0">
              ...
              <div className="md:col-span-2 p-5">
                ...
                {/* Features */}
                <div className="mb-4">
                  <h4 className="font-semibold text-amber-700 mb-2 text-base">
                    Key Features:
                  </h4>
                ...
                <div className="p-3 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-lg">
                  <h4 className="font-semibold text-amber-700 mb-2 flex items-center gap-2 text-base">
