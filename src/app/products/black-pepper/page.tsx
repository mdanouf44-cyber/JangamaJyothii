...
const BlackPepperSlideshow = ({ varieties }: { varieties: any[] }) => {
  ...
  return (
    <div className="relative max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {currentProducts.map((product, index) => (
          ...
          >
            ...
            <div className="relative h-72 lg:h-80 bg-gradient-to-br from-gray-50 to-slate-50">
              <Image
                src={product.image}
                alt={product.name}
                fill
      ...
      <div className="flex justify-between items-center mt-6">
        ...
        <button
          onClick={prevSlide}
          className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-500 transition-all duration-300 shadow-sm hover:shadow-md"
        >
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-slate-50">
        <div className="container mx-auto px-4">
          ...
          <BlackPepperSlideshow varieties={varieties} />
        </div>
      </section>
